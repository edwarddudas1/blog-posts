    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 14:
          ...
          console.error("Error fetching or processing data", _context2.t0);
        case 17:
        case "end":
...
function _createPost() {
  _createPost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(title, content) {
...
var updatePost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, title, content) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return fetch("http://localhost:3000/posts/".concat(id), {
            ...
            body: JSON.stringify({
              title: title,
              content: content
            }) // Send the post data as an object
          });
        case 3:
        ...
        case 14:
          ...
          console.error("Error updating post:", _context.t0);
        case 17:
        case "end":
...
function _deletePost() {
  _deletePost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    var response;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          postsArray = postsArray.filter(function (post) {
...
function _createComment() {
  _createComment = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(postId, commentText) {
    var response, result;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          _context5.prev = 4;
          _context5.next = 7;
          return fetch("http://localhost:3000/posts/".concat(postId, "/comments"), {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            },
        ...
        case 7:
          ...
          throw new Error("Failed to create comment. Server responded with status ".concat(response.status));
        case 10:
          _context5.next = 12;
          return response.json();
        case 12:
          ...
          postsArray = postsArray.map(function (post) {
            return post.id === postId ? _objectSpread(_objectSpread({}, post), {}, {
              comments: [].concat(_toConsumableArray(post.comments || []), [result.comment])
            }) : post;
          });
          renderPosts(postsArray);
          _context5.next = 21;
        ...
        case 18:
          ...
          console.error("❌ Error creating comment:", _context5.t0);
        case 21:
        case "end":
...
document.addEventListener("click", function (event) {
  if (event.target.classList.contains("editPostButton")) {
    var findId = event.target.getAttribute("data-id");
    var newTitle = prompt("Enter new title:");
    var newText = prompt("Enter new content:");
    if (newTitle && newText) {
      console.log("Updating post with ID: ".concat(findId));
...
document.addEventListener("submit", function (event) {
  if (event.target.classList.contains("createCommentForm")) {
    ...
    var postId = Number(event.target.getAttribute("data-post-id"));
    var commentInput = event.target.querySelector(".commentInput");
...
function _startApp() {
  _startApp = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var posts, sourceElement, source;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          sourceElement = document.querySelector(".menuTemplate");
          source = sourceElement.innerHTML || sourceElement.content.firstElementChild.innerHTML;
          if (source.trim()) {
            _context6.next = 8;
            break;
          }
